workspace(name = "baracoda-tutorial")
...
http_archive(
    name = "com_github_mediapipe",
    patch_args = [
        "-p1",
    ],
    patches = [
        "//third_party:mediapipe_ios.patch",
    ],
    sha256 = "54ce6da9f167d34fe53f928c804b3bc1fd1dd8fe2b32ca4bf0b63325d34680ac",
    strip_prefix = "mediapipe-%s" % MEDIAPIPE_VERSION,
    type = "tar.gz",
    urls = [
        "https://github.com/google/mediapipe/archive/refs/tags/v%s.tar.gz" % MEDIAPIPE_VERSION,
    ],
)
...
http_archive(
    ...
    patches = [
        "@com_github_mediapipe//third_party:com_google_absl_f863b622fe13612433fdf43f76547d5edda0c93001.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        "@com_github_mediapipe//third_party:ceres_solver_compatibility_fixes.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        ...
        "@com_github_mediapipe//third_party:build_bazel_rules_apple_bypass_test_runner_check.diff"
    ],
    patch_args = [
        "-p1",
    ],
...
http_archive(
    ...
    patches = [
        "@com_github_mediapipe//third_party:org_tensorflow_compatibility_fixes.diff",
        "@com_github_mediapipe//third_party:org_tensorflow_objc_cxx17.diff",
        # Diff is generated with a script, don't update it manually.
        "@com_github_mediapipe//third_party:org_tensorflow_custom_ops.diff",
    ],
    patch_args = [
        "-p1",
    ],
